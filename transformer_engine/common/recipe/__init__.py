...
class Recipe:
    ...
    def hybrid_nvfp4(self):
        """Whether the given recipe has NVFP4 for(ward and MXFP8 backward strategy."""
...
class NVFP4BlockScaling(Recipe):
    ...
    fp4_format: Format = Format.E2M1
    fp8_format: Format = Format.E4M3
    fp8_quant_fwd_inp = QParams(double_quantization=False, fp4_random_hadamard_transform=False, fp4_stochastic_rounding=False)
    fp8_quant_fwd_weight = QParams(double_quantization=False, fp4_random_hadamard_transform=False, fp4_stochastic_rounding=False)
    fp8_quant_bwd_grad = QParams(double_quantization=False, fp4_random_hadamard_transform=False, fp4_stochastic_rounding=False)

...
def check_quantization_nvfp4_versus_reference(
    ...
    assert not with_random_sign_mask, "Random sign mask is not supported yet."
    ...
    nvfp4_quantizer = NVFP4Quantizer(
        ...
        # TODO(Frank): For distributed testing, we want to set
    ...
    ref_amax_rowwise = x_nvfp4_ref.global_amax
